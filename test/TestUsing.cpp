...
TEST(TestLibrary, TestUsing)
{
    ...
    auto factory = type->factory.find("TestContainerWithIteratorUsing<int>(TestContainerWithIteratorUsing<int>::Iterator, TestContainerWithIteratorUsing<int>::Iterator)");
