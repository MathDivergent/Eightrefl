...
TEST(TestBuiltin, TestSet)
{
    ...
    EXPECT("factory-R()", type->factory.find("std::set<int>()") != nullptr);

    #ifdef EIGHTREFL_FULLY_ENABLE
    EXPECT("factory-R(key_compare const&, allocator_type const&)", type->factory.find("std::set<int>(std::less<int> const&, std::allocator<int> const&)") != nullptr);
    EXPECT("factory-R(key_compare const&)", type->factory.find("std::set<int>(std::less<int> const&)") != nullptr);
    EXPECT("factory-R(allocator_type const&)", type->factory.find("std::set<int>(std::allocator<int> const&)") != nullptr);
    EXPECT("factory-R(const_iterator, const_iterator, key_compare const&, allocator_type const&)", type->factory.find("std::set<int>(std::set<int>::const_iterator, std::set<int>::const_iterator, std::less<int> const&, std::allocator<int> const&)") != nullptr);
    EXPECT("factory-R(const_iterator, const_iterator, allocator_type const&)", type->factory.find("std::set<int>(std::set<int>::const_iterator, std::set<int>::const_iterator, std::allocator<int> const&)") != nullptr);
    #endif // EIGHTREFL_FULLY_ENABLE

    EXPECT("factory-R(R const&)", type->factory.find("std::set<int>(std::set<int> const&)") != nullptr);

    #ifdef EIGHTREFL_FULLY_ENABLE
    EXPECT("factory-R(R const&, allocator_type const&)", type->factory.find("std::set<int>(std::set<int> const&, std::allocator<int> const&)") != nullptr);
    EXPECT("factory-R(std::initializer_list<value_type>, key_compare const&, allocator_type const&)", type->factory.find("std::set<int>(std::initializer_list<int>, std::less<int> const&, std::allocator<int> const&)") != nullptr);
