...
TEST(TestBuiltin, TestDeque)
{
    ...
    EXPECT("factory-R()", type->factory.find("std::deque<int>()") != nullptr);

    #ifdef EIGHTREFL_FULLY_ENABLE
    EXPECT("factory-R(allocator_type const&)", type->factory.find("std::deque<int>(std::allocator<int> const&)") != nullptr);
    EXPECT("factory-R(size_type, const_reference, allocator_type const&)", type->factory.find("std::deque<int>(unsigned long, int const&, std::allocator<int> const&)") != nullptr || type->factory.find("std::deque<int>(unsigned long long, int const&, std::allocator<int> const&)") != nullptr);
    EXPECT("factory-R(size_type, const_reference)", type->factory.find("std::deque<int>(unsigned long, int const&)") != nullptr || type->factory.find("std::deque<int>(unsigned long long, int const&)") != nullptr);
    EXPECT("factory-R(size_type, allocator_type const&)", type->factory.find("std::deque<int>(unsigned long, std::allocator<int> const&)") != nullptr || type->factory.find("std::deque<int>(unsigned long long, std::allocator<int> const&)") != nullptr);
    EXPECT("factory-R(size_type)", type->factory.find("std::deque<int>(unsigned long)") != nullptr || type->factory.find("std::deque<int>(unsigned long long)") != nullptr);
    EXPECT("factory-R(const_iterator, const_iterator, allocator_type const&)", type->factory.find("std::deque<int>(std::deque<int>::const_iterator, std::deque<int>::const_iterator, std::allocator<int> const&)") != nullptr);
    EXPECT("factory-R(const_iterator, const_iterator)", type->factory.find("std::deque<int>(std::deque<int>::const_iterator, std::deque<int>::const_iterator)") != nullptr);
    EXPECT("factory-R(R const&, allocator_type const&)", type->factory.find("std::deque<int>(std::deque<int> const&, std::allocator<int> const&)") != nullptr);
    #endif // EIGHTREFL_FULLY_ENABLE

    EXPECT("factory-R(R const&)", type->factory.find("std::deque<int>(std::deque<int> const&)") != nullptr);

    #ifdef EIGHTREFL_FULLY_ENABLE
    EXPECT("factory-R(std::initializer_list<value_type>, allocator_type const&)", type->factory.find("std::deque<int>(std::initializer_list<int>, std::allocator<int> const&)") != nullptr);
    EXPECT("factory-R(std::initializer_list<value_type>)", type->factory.find("std::deque<int>(std::initializer_list<int>)") != nullptr);
    #endif // EIGHTREFL_FULLY_ENABLE
